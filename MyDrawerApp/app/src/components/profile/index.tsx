    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardDescription}>Add your profile information here</Text> 
...
const styles = StyleSheet.create({
  ...
  buttonText: { ...TYPOGRAPHY.h2, color: COLORS.black, borderWidth:1,textAlign: 'center', marginBottom: SPACING.lg },
});
